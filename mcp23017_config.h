...
typedef enum {
    MCP23017_SLAVE_ADDRESS_A2H_A1H_A0H = 0b0100111,
    MCP23017_SLAVE_ADDRESS_A2H_A1H_A0L = 0b0100110,
    MCP23017_SLAVE_ADDRESS_A2H_A1L_A0H = 0b0100101,
    MCP23017_SLAVE_ADDRESS_A2L_A1H_A0H = 0b0100011,
    MCP23017_SLAVE_ADDRESS_A2H_A1L_A0L = 0b0100100,
    MCP23017_SLAVE_ADDRESS_A2L_A1H_A0L = 0b0100010,
    MCP23017_SLAVE_ADDRESS_A2L_A1L_A0H = 0b0100001,
    MCP23017_SLAVE_ADDRESS_A2L_A1L_A0L = 0b0100000,
} mcp23017_slave_address_t;
...
typedef struct {
    void* bus_user;
    mcp23017_err_t (*bus_initialize)(void*);
    mcp23017_err_t (*bus_deinitialize)(void*);
