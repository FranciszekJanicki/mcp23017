...
static mcp23017_err_t mcp23017_bus_initialize(mcp23017_t const *mcp23017) {
  return mcp23017->interface.bus_initialize
             ? mcp23017->interface.bus_initialize(mcp23017->interface.bus_user)
             : MCP23017_ERR_NULL;
}

static mcp23017_err_t mcp23017_bus_deinitialize(mcp23017_t const *mcp23017) {
  return mcp23017->interface.bus_deinitialize
             ? mcp23017->interface.bus_deinitialize(
                   mcp23017->interface.bus_user)
             : MCP23017_ERR_NULL;
}

static mcp23017_err_t mcp23017_bus_write_data(mcp23017_t const *mcp23017,
                                              uint8_t address,
                                              uint8_t const *data,
                                              size_t data_size) {
  return mcp23017->interface.bus_write_data
             ? mcp23017->interface.bus_write_data(mcp23017->interface.bus_user,
                                                  address, data, data_size)
             : MCP23017_ERR_NULL;
}

static mcp23017_err_t mcp23017_bus_read_data(mcp23017_t const *mcp23017,
                                             uint8_t address, uint8_t *data,
                                             size_t data_size) {
  return mcp23017->interface.bus_read_data
             ? mcp23017->interface.bus_read_data(mcp23017->interface.bus_user,
                                                 address, data, data_size)
             : MCP23017_ERR_NULL;
}

static mcp23017_err_t mcp23017_port_write(mcp23017_t const *mcp23017,
                                          mcp23017_port_t port, uint8_t address,
                                          uint8_t const *data,
                                          size_t data_size) {
  return mcp23017_bus_write_data(
      mcp23017, mcp23017_port_to_address(port, mcp23017->config.bank, address),
      data, data_size);
}
...
mcp23017_err_t mcp23017_initialize(mcp23017_t *mcp23017,
  ...
  return mcp23017_bus_initialize(mcp23017);
}

mcp23017_err_t mcp23017_deinitialize(mcp23017_t *mcp23017) {
  assert(mcp23017);

  mcp23017_err_t err = mcp23017_bus_deinitialize(mcp23017);
...
mcp23017_err_t mcp23017_get_pin_state(mcp23017_t const *mcp23017,
  ...
  mcp23017_err_t err = mcp23017_port_read(
      mcp23017, port, MCP23017_REG_ADDRESS_GPIO, &reg, sizeof(reg));
...
mcp23017_err_t mcp23017_set_pin_state(mcp23017_t const *mcp23017,
  ...
  err |= mcp23017_port_write(mcp23017, port, MCP23017_REG_ADDRESS_GPIO, &reg,
                             sizeof(reg));
...
mcp23017_err_t mcp23017_get_iodir_reg(mcp23017_t const *mcp23017,
  ...
  mcp23017_err_t err = mcp23017_port_read(
      mcp23017, port, MCP23017_REG_ADDRESS_IODIR, &data, sizeof(data));
...
mcp23017_err_t mcp23017_set_iodir_reg(mcp23017_t const *mcp23017,
  ...
  return mcp23017_port_write(mcp23017, port, MCP23017_REG_ADDRESS_IODIR, &data,
                             sizeof(data));
}
...
mcp23017_err_t mcp23017_get_ipol_reg(mcp23017_t const *mcp23017,
  ...
  mcp23017_err_t err = mcp23017_port_read(
      mcp23017, port, MCP23017_REG_ADDRESS_IPOL, &data, sizeof(data));
...
mcp23017_err_t mcp23017_set_ipol_reg(mcp23017_t const *mcp23017,
  ...
  return mcp23017_port_write(mcp23017, port, MCP23017_REG_ADDRESS_IPOL, &data,
                             sizeof(data));
}
...
mcp23017_err_t mcp23017_get_gpinten_reg(mcp23017_t const *mcp23017,
  ...
  mcp23017_err_t err = mcp23017_port_read(
      mcp23017, port, MCP23017_REG_ADDRESS_GPINTEN, &data, sizeof(data));
...
mcp23017_err_t mcp23017_set_gpinten_reg(mcp23017_t const *mcp23017,
  ...
  return mcp23017_port_write(mcp23017, port, MCP23017_REG_ADDRESS_GPINTEN,
                             &data, sizeof(data));
}
...
mcp23017_err_t mcp23017_get_defval_reg(mcp23017_t const *mcp23017,
  ...
  mcp23017_err_t err = mcp23017_port_read(
      mcp23017, port, MCP23017_REG_ADDRESS_DEFVAL, &data, sizeof(data));
...
mcp23017_err_t mcp23017_set_defval_reg(mcp23017_t const *mcp23017,
  ...
  return mcp23017_port_write(mcp23017, port, MCP23017_REG_ADDRESS_DEFVAL, &data,
                             sizeof(data));
}
...
mcp23017_err_t mcp23017_get_intcon_reg(mcp23017_t const *mcp23017,
  ...
  mcp23017_err_t err = mcp23017_port_read(
      mcp23017, port, MCP23017_REG_ADDRESS_INTCON, &data, sizeof(data));
...
mcp23017_err_t mcp23017_set_intcon_reg(mcp23017_t const *mcp23017,
  ...
  return mcp23017_port_write(mcp23017, port, MCP23017_REG_ADDRESS_INTCON, &data,
                             sizeof(data));
}
...
mcp23017_err_t mcp23017_get_iocon_reg(mcp23017_t const *mcp23017,
  ...
  mcp23017_err_t err = mcp23017_port_read(
      mcp23017, port, MCP23017_REG_ADDRESS_IOCON, &data, sizeof(data));
...
mcp23017_err_t mcp23017_set_iocon_reg(mcp23017_t const *mcp23017,
  ...
  return mcp23017_port_write(mcp23017, port, MCP23017_REG_ADDRESS_IOCON, &data,
                             sizeof(data));
}
...
mcp23017_err_t mcp23017_get_gppu_reg(mcp23017_t const *mcp23017,
  ...
  mcp23017_err_t err = mcp23017_port_read(
      mcp23017, port, MCP23017_REG_ADDRESS_GPPU, &data, sizeof(data));
...
mcp23017_err_t mcp23017_set_gppu_reg(mcp23017_t const *mcp23017,
  ...
  return mcp23017_port_write(mcp23017, port, MCP23017_REG_ADDRESS_GPPU, &data,
                             sizeof(data));
}
...
mcp23017_err_t mcp23017_get_intf_reg(mcp23017_t const *mcp23017,
  ...
  mcp23017_err_t err = mcp23017_port_read(
      mcp23017, port, MCP23017_REG_ADDRESS_INTF, &data, sizeof(data));
...
mcp23017_err_t mcp23017_get_intcap_reg(mcp23017_t const *mcp23017,
  ...
  mcp23017_err_t err = mcp23017_port_read(
      mcp23017, port, MCP23017_REG_ADDRESS_INTCAP, &data, sizeof(data));
...
mcp23017_err_t mcp23017_get_gpio_reg(mcp23017_t const *mcp23017,
  ...
  mcp23017_err_t err = mcp23017_port_read(
      mcp23017, port, MCP23017_REG_ADDRESS_GPIO, &data, sizeof(data));
...
mcp23017_err_t mcp23017_set_gpio_reg(mcp23017_t const *mcp23017,
  ...
  return mcp23017_port_write(mcp23017, port, MCP23017_REG_ADDRESS_GPIO, &data,
                             sizeof(data));
}
